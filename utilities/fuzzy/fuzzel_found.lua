...
local strlen,chrat,min,asrt,prs,iprs,typ,upack,tblins,tblsrt,strsub,tru,fal,tblcat = utf8.len,utf8.byte,math.min,assert,pairs,ipairs,type,unpack,table.insert,table.sort,utf8.sub,true,false,table.concat
